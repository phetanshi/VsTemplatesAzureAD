...
namespace PsTest.UnitTest.UI.Components
{
    public class SampleTests
    {
        ...
        public async Task Sample_WhenComponentRendered()
        {
            ...
            sampleServiceHandlerMock.Setup(x => x.GetUsersAsync()).ReturnsAsync(new List<Person> { new Person { UserId = "CORP\\e777777" } });
        ...
        public async Task Sample_WhenComponentRenderedAndUserObjectIsNull()
        {
            ...
            sampleServiceHandlerMock.Setup(x => x.GetUsersAsync()).ReturnsAsync(default(List<Person>));
